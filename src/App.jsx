    ...
    <Suspense fallback={<LoadingSpinner />}>
      <Routes>
        <Route path="/" element={<MainLayout />}>
          ...
          <Route path="terms" element={<TermsPage />} />
          <Route path="privacy" element={<PrivacyPage />} />
          {/* New Routes for HomePage categories */}
          <Route path="programming-web-design" element={<ProgrammingAndWebDesignPage />} />
          <Route path="kids-programming" element={<KidsProgrammingPage />} />
          <Route path="intro-to-programming" element={<IntroToProgrammingPage />} />
          <Route path="deaf-courses" element={<DeafCoursesPage />} />
          <Route path="*" element={<NotFoundPage />} />
        </Route>
      </Routes>
    </Suspense>
