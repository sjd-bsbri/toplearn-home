...
const categories = [
  { id: 1, name: 'برنامه نویسی و طراحی وب', path: '/programming-web-design' },
  { id: 2, name: 'آموزش برنامه نویسی به کودکان', path: '/kids-programming' },
  { id: 3, name: 'آموزش ورود به دنیای برنامه نویسی', path: '/intro-to-programming' },
  { id: 4, name: 'دوره های مخصوص ناشنوایان', path: '/deaf-courses' },
];
